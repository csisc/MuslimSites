...
/* Empty layer placeholder to add to layer control for listening when to add/remove mosques to markerClusters layer */
var mosqueLayer = L.geoJson(null);
var mosques = L.geoJson(null, {
  pointToLayer: function (feature, latlng) {
    return L.marker(latlng, {
      icon: L.icon({
        iconUrl: "assets/img/mosques.png",
        iconSize: [24, 28],
        iconAnchor: [12, 28],
        popupAnchor: [0, -25]
      }),
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Wikipedia</th><td>" + feature.properties.WIKIPEDIA + '<a href="https://hub.toolforge.org/' + feature.properties.QID + '" class="button">Read</a> <a href="https://sawtpedia.toolforge.org/link?id=' + feature.properties.QID + '" class="button">Listen</a> ' + "</td></tr>" + '<tr><th>Image</th><td><img src="' + feature.properties.IMAGE + '" height="150" /></td></tr>' + "<tr><th>Website</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
          $("#feature-title").html(feature.properties.NAME);
          $("#feature-info").html(content);
